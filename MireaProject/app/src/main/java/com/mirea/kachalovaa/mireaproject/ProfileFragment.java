...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        titleField = view.findViewById(R.id.titleText);
        contentField = view.findViewById(R.id.contentText);
        ...
        contentField.setText(sharedPref.getString("NOTE_CONTENT", "Some text"));
    }
