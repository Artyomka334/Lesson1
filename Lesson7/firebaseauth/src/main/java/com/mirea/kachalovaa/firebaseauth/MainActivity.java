package com.mirea.kachalovaa.firebaseauth;
...
import com.mirea.kachalovaa.firebaseauth.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateUI(FirebaseUser user) {
        if (user != null) {
            ...
            binding.emailPasswordMethod.setText("Signed Out");
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        // [START_EXCLUDE]
                        if (!task.isSuccessful()) {
                            binding.emailPasswordMethod.setText("Authentication failed");
                        }
// [END_EXCLUDE]
                    }
                });
